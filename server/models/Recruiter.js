...
const recruiterSchema = new mongoose.Schema({
  ...
  company: {
    ...
    industry: {
      ...
      enum: [
        ...
        'Non-profit', 'Consulting', 'Real Estate', 'Hospitality', 'Other'
      ]
    },
    size: {
      type: String,
  ...
  department: {
    type: String,
    enum: ['HR', 'Engineering', 'Sales', 'Marketing', 'Operations', 'Finance', 'Other'],
    default: 'HR'
  },
...
recruiterSchema.pre('save', function(next) {
  ...
  const fields = [
    ...
    'company.name', 'company.industry', 'company.size', 'company.city'
  ];
