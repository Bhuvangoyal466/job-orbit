...
const getDashboardStats = async (req, res, next) => {
  try {
    ...
    const stats = {
      ...
      totalApplicationsReceived: recruiter.stats.totalApplicationsReceived,
    ...
    res.status(200).json({
      ...
      data: {
        ...
        verificationRequirements: {
          emailVerification: recruiter.isEmailVerified ? 'Completed' : 'Pending',
          companyVerification: recruiter.isCompanyVerified ? 'Completed' : 'Pending',
